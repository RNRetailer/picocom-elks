...
#endif
#ifdef GENERATOR_FILE
extern int flag_instrument_function_entry_exit_simple;
#else
  int x_flag_instrument_function_entry_exit_simple;
#define flag_instrument_function_entry_exit_simple global_options.x_flag_instrument_function_entry_exit_simple
#endif
#ifdef GENERATOR_FILE
...
#else
  int x_target_arch;
#define target_arch global_options.x_target_arch
#endif
#ifdef GENERATOR_FILE
extern int ia16_asm_dialect;
#else
  int x_ia16_asm_dialect;
#define ia16_asm_dialect global_options.x_ia16_asm_dialect
#endif
#ifdef GENERATOR_FILE
extern int target_call_parm_cvt;
#else
  int x_target_call_parm_cvt;
#define target_call_parm_cvt global_options.x_target_call_parm_cvt
#endif
#ifdef GENERATOR_FILE
extern int target_cmodel;
#else
  int x_target_cmodel;
#define target_cmodel global_options.x_target_cmodel
#endif
#ifdef GENERATOR_FILE
extern const char *target_runtime;
#else
  const char *x_target_runtime;
#define target_runtime global_options.x_target_runtime
#endif
#ifdef GENERATOR_FILE
extern int target_tune;
#else
  int x_target_tune;
#define target_tune global_options.x_target_tune
#endif
#ifdef GENERATOR_FILE
...
#ifndef GENERATOR_FILE
  int x_VAR_maout;
#define x_VAR_maout do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_maout_chmem_;
#define x_VAR_maout_chmem_ do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_maout_heap_;
#define x_VAR_maout_heap_ do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_maout_stack_;
#define x_VAR_maout_stack_ do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_maout_symtab;
#define x_VAR_maout_symtab do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_maout_total_;
#define x_VAR_maout_total_ do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_mfar_function_if_far_return_type;
#define x_VAR_mfar_function_if_far_return_type do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_mhandle_non_i186;
#define x_VAR_mhandle_non_i186 do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_mhandle_non_i286;
#define x_VAR_mhandle_non_i286 do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_mmsdos_handle_v1;
#define x_VAR_mmsdos_handle_v1 do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_mno_post_link;
#define x_VAR_mno_post_link do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_mseparate_code_segment;
#define x_VAR_mseparate_code_segment do_not_use
#endif
#ifndef GENERATOR_FILE
...
#define MASK_NO_ASSUME_DS_DATA (1 << 0)
#define MASK_NO_ASSUME_SS_DATA (1 << 1)
#define MASK_DOSX (1 << 2)
#define MASK_DOSX32 (1 << 3)
#define MASK_NO_NEWLIB_AUTOFLOAT_STDIO (1 << 4)
#define MASK_NEWLIB_NANO_STDIO (1 << 5)
#define MASK_SEG_RELOC_STUFF (1 << 6)
#define MASK_PROTECTED_MODE (1 << 7)
#define MASK_ABI_SEGELF (1 << 8)
#define MASK_SHORT_JUMPS (1 << 9)
#define MASK_TSR (1 << 10)

#define TARGET_NO_ASSUME_DS_DATA ((target_flags & MASK_NO_ASSUME_DS_DATA) != 0)
#define TARGET_NO_ASSUME_DS_DATA_P(target_flags) ((target_flags & MASK_NO_ASSUME_DS_DATA) != 0)
#define TARGET_NO_ASSUME_SS_DATA ((target_flags & MASK_NO_ASSUME_SS_DATA) != 0)
#define TARGET_NO_ASSUME_SS_DATA_P(target_flags) ((target_flags & MASK_NO_ASSUME_SS_DATA) != 0)
#define TARGET_DOSX ((target_flags & MASK_DOSX) != 0)
#define TARGET_DOSX_P(target_flags) ((target_flags & MASK_DOSX) != 0)
#define TARGET_DOSX32 ((target_flags & MASK_DOSX32) != 0)
#define TARGET_DOSX32_P(target_flags) ((target_flags & MASK_DOSX32) != 0)
#define TARGET_NO_NEWLIB_AUTOFLOAT_STDIO ((target_flags & MASK_NO_NEWLIB_AUTOFLOAT_STDIO) != 0)
#define TARGET_NO_NEWLIB_AUTOFLOAT_STDIO_P(target_flags) ((target_flags & MASK_NO_NEWLIB_AUTOFLOAT_STDIO) != 0)
#define TARGET_NEWLIB_NANO_STDIO ((target_flags & MASK_NEWLIB_NANO_STDIO) != 0)
#define TARGET_NEWLIB_NANO_STDIO_P(target_flags) ((target_flags & MASK_NEWLIB_NANO_STDIO) != 0)
#define TARGET_SEG_RELOC_STUFF ((target_flags & MASK_SEG_RELOC_STUFF) != 0)
#define TARGET_SEG_RELOC_STUFF_P(target_flags) ((target_flags & MASK_SEG_RELOC_STUFF) != 0)
#define TARGET_PROTECTED_MODE ((target_flags & MASK_PROTECTED_MODE) != 0)
#define TARGET_PROTECTED_MODE_P(target_flags) ((target_flags & MASK_PROTECTED_MODE) != 0)
#define TARGET_ABI_SEGELF ((target_flags & MASK_ABI_SEGELF) != 0)
#define TARGET_ABI_SEGELF_P(target_flags) ((target_flags & MASK_ABI_SEGELF) != 0)
#define TARGET_SHORT_JUMPS ((target_flags & MASK_SHORT_JUMPS) != 0)
#define TARGET_SHORT_JUMPS_P(target_flags) ((target_flags & MASK_SHORT_JUMPS) != 0)
#define TARGET_TSR ((target_flags & MASK_TSR) != 0)
#define TARGET_TSR_P(target_flags) ((target_flags & MASK_TSR) != 0)

#define TARGET_ASSUME_DS_DATA ((target_flags & MASK_NO_ASSUME_DS_DATA) == 0)
#define TARGET_ASSUME_SS_DATA ((target_flags & MASK_NO_ASSUME_SS_DATA) == 0)
#define TARGET_NEWLIB_AUTOFLOAT_STDIO ((target_flags & MASK_NO_NEWLIB_AUTOFLOAT_STDIO) == 0)
...
enum opt_code
{
  ...
  OPT_Wprio_ctor_dtor = 349,                 /* -Wprio-ctor-dtor */
  ...
  OPT_dumpfullversion = 484,                 /* -dumpfullversion */
  ...
  OPT_finstrument_functions_simple = 761,    /* -finstrument-functions-simple */
  ...
  OPT_maout = 1184,                          /* -maout */
  OPT_maout_chmem_ = 1185,                   /* -maout-chmem= */
  OPT_maout_heap_ = 1186,                    /* -maout-heap= */
  OPT_maout_stack_ = 1187,                   /* -maout-stack= */
  OPT_maout_symtab = 1188,                   /* -maout-symtab */
  OPT_maout_total_ = 1189,                   /* -maout-total= */
  OPT_march_any = 1190,                      /* -march=any */
  OPT_march_any_186 = 1191,                  /* -march=any_186 */
  /* OPT_march_i186 = 1192, */               /* -march=i186 */
  /* OPT_march_i188 = 1193, */               /* -march=i188 */
  /* OPT_march_i286 = 1194, */               /* -march=i286 */
  OPT_march_i80186 = 1195,                   /* -march=i80186 */
  OPT_march_i80188 = 1196,                   /* -march=i80188 */
  OPT_march_i80286 = 1197,                   /* -march=i80286 */
  OPT_march_i8086 = 1198,                    /* -march=i8086 */
  OPT_march_i8088 = 1199,                    /* -march=i8088 */
  OPT_march_v20 = 1200,                      /* -march=v20 */
  OPT_march_v30 = 1201,                      /* -march=v30 */
  OPT_march_v30mz = 1202,                    /* -march=v30mz */
  OPT_masm_att = 1203,                       /* -masm=att */
  OPT_masm_intel = 1204,                     /* -masm=intel */
  OPT_mcallee_assume_ds_data_segment = 1205, /* -mcallee-assume-ds-data-segment */
  /* OPT_mcallee_assume_ds_data_space = 1206, *//* -mcallee-assume-ds-data-space */
  /* OPT_mcallee_assume_ds_ss = 1207, */     /* -mcallee-assume-ds-ss */
  OPT_mcallee_assume_ss_data_segment = 1208, /* -mcallee-assume-ss-data-segment */
  OPT_mcdecl = 1209,                         /* -mcdecl */
  OPT_mcmodel_medium = 1210,                 /* -mcmodel=medium */
  OPT_mcmodel_small = 1211,                  /* -mcmodel=small */
  OPT_mcmodel_tiny = 1212,                   /* -mcmodel=tiny */
  OPT_mdosx = 1213,                          /* -mdosx */
  OPT_mdosx32 = 1214,                        /* -mdosx32 */
  /* OPT_mdpmi = 1215, */                    /* -mdpmi */
  /* OPT_melks = 1216, */                    /* -melks */
  /* OPT_melks_libc = 1217, */               /* -melks-libc */
  OPT_mfar_function_if_far_return_type = 1218,/* -mfar-function-if-far-return-type */
  OPT_mhandle_non_i186 = 1219,               /* -mhandle-non-i186 */
  OPT_mhandle_non_i286 = 1220,               /* -mhandle-non-i286 */
  /* OPT_mmsdos = 1221, */                   /* -mmsdos */
  OPT_mmsdos_handle_v1 = 1222,               /* -mmsdos-handle-v1 */
  OPT_mnewlib_autofloat_stdio = 1223,        /* -mnewlib-autofloat-stdio */
  OPT_mnewlib_nano_stdio = 1224,             /* -mnewlib-nano-stdio */
  OPT_mno_callee_assume_ds_data_segment = 1225,/* -mno-callee-assume-ds-data-segment */
  OPT_mno_callee_assume_ss_data_segment = 1226,/* -mno-callee-assume-ss-data-segment */
  OPT_mno_newlib_autofloat_stdio = 1227,     /* -mno-newlib-autofloat-stdio */
  OPT_mno_post_link = 1228,                  /* -mno-post-link */
  OPT_mno_segment_relocation_stuff = 1229,   /* -mno-segment-relocation-stuff */
  OPT_mprotected_mode = 1230,                /* -mprotected-mode */
  OPT_mr_ = 1231,                            /* -mr= */
  OPT_mregparmcall = 1232,                   /* -mregparmcall */
  OPT_mrtd = 1233,                           /* -mrtd */
  OPT_msegelf = 1234,                        /* -msegelf */
  OPT_msegment_relocation_stuff = 1235,      /* -msegment-relocation-stuff */
  OPT_mseparate_code_segment = 1236,         /* -mseparate-code-segment */
  OPT_mshort_jumps = 1237,                   /* -mshort-jumps */
  /* OPT_mstack_size_ = 1238, */             /* -mstack-size= */
  /* OPT_mstdcall = 1239, */                 /* -mstdcall */
  OPT_mtsr = 1240,                           /* -mtsr */
  OPT_mtune_any = 1241,                      /* -mtune=any */
  OPT_mtune_any_186 = 1242,                  /* -mtune=any_186 */
  /* OPT_mtune_i186 = 1243, */               /* -mtune=i186 */
  /* OPT_mtune_i188 = 1244, */               /* -mtune=i188 */
  /* OPT_mtune_i286 = 1245, */               /* -mtune=i286 */
  OPT_mtune_i80186 = 1246,                   /* -mtune=i80186 */
  OPT_mtune_i80188 = 1247,                   /* -mtune=i80188 */
  OPT_mtune_i80286 = 1248,                   /* -mtune=i80286 */
  OPT_mtune_i8086 = 1249,                    /* -mtune=i8086 */
  OPT_mtune_i8088 = 1250,                    /* -mtune=i8088 */
  OPT_mtune_v20 = 1251,                      /* -mtune=v20 */
  OPT_mtune_v30 = 1252,                      /* -mtune=v30 */
  OPT_mtune_v30mz = 1253,                    /* -mtune=v30mz */
  OPT_n = 1254,                              /* -n */
  OPT_no_canonical_prefixes = 1255,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1256,              /* -no-integrated-cpp */
  OPT_no_pie = 1257,                         /* -no-pie */
  OPT_nocpp = 1258,                          /* -nocpp */
  OPT_nodefaultlibs = 1259,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1260,                   /* -nostartfiles */
  OPT_nostdinc = 1261,                       /* -nostdinc */
  OPT_nostdinc__ = 1262,                     /* -nostdinc++ */
  OPT_nostdlib = 1263,                       /* -nostdlib */
  OPT_o = 1264,                              /* -o */
  OPT_p = 1265,                              /* -p */
  OPT_pass_exit_codes = 1266,                /* -pass-exit-codes */
  /* OPT_pedantic = 1267, */                 /* -pedantic */
  OPT_pedantic_errors = 1268,                /* -pedantic-errors */
  OPT_pg = 1269,                             /* -pg */
  OPT_pie = 1270,                            /* -pie */
  OPT_pipe = 1271,                           /* -pipe */
  ...
  OPT_r = 1284,                              /* -r */
  OPT_remap = 1285,                          /* -remap */
  OPT_s = 1286,                              /* -s */
  OPT_s_bc_abi = 1287,                       /* -s-bc-abi */
  ...
  OPT_static_libgcj = 1297,                  /* -static-libgcj */
  OPT_static_libgfortran = 1298,             /* -static-libgfortran */
  OPT_static_libgo = 1299,                   /* -static-libgo */
  OPT_static_liblsan = 1300,                 /* -static-liblsan */
  OPT_static_libmpx = 1301,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1302,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1303,               /* -static-libstdc++ */
  OPT_static_libtsan = 1304,                 /* -static-libtsan */
  OPT_static_libubsan = 1305,                /* -static-libubsan */
  ...
  OPT_std_c__98 = 1313,                      /* -std=c++98 */
  OPT_std_c11 = 1314,                        /* -std=c11 */
  /* OPT_std_c1x = 1315, */                  /* -std=c1x */
  /* OPT_std_c89 = 1316, */                  /* -std=c89 */
  OPT_std_c90 = 1317,                        /* -std=c90 */
  OPT_std_c99 = 1318,                        /* -std=c99 */
  /* OPT_std_c9x = 1319, */                  /* -std=c9x */
  OPT_std_f2003 = 1320,                      /* -std=f2003 */
  OPT_std_f2008 = 1321,                      /* -std=f2008 */
  OPT_std_f2008ts = 1322,                    /* -std=f2008ts */
  ...
  OPT_std_legacy = 1344,                     /* -std=legacy */
  OPT_symbolic = 1345,                       /* -symbolic */
  OPT_t = 1346,                              /* -t */
  OPT_time = 1347,                           /* -time */
  OPT_time_ = 1348,                          /* -time= */
  OPT_traditional = 1349,                    /* -traditional */
  OPT_traditional_cpp = 1350,                /* -traditional-cpp */
  OPT_trigraphs = 1351,                      /* -trigraphs */
  OPT_u = 1352,                              /* -u */
  OPT_undef = 1353,                          /* -undef */
  OPT_v = 1354,                              /* -v */
  OPT_version = 1355,                        /* -version */
  OPT_w = 1356,                              /* -w */
  OPT_wrapper = 1357,                        /* -wrapper */
  OPT_x = 1358,                              /* -x */
  OPT_z = 1359,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
