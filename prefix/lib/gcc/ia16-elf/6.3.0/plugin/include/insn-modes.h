/* Generated automatically from machmode.def and config/ia16/ia16-modes.def
   by genmodes.  */
...
#define HAVE_CCmode
  CCZmode,                 /* config/ia16/ia16-modes.def:37 */
#define HAVE_CCZmode
  CCZ_Cmode,               /* config/ia16/ia16-modes.def:41 */
#define HAVE_CCZ_Cmode
  CCZ_NCmode,              /* config/ia16/ia16-modes.def:45 */
#define HAVE_CCZ_NCmode
  CCCmode,                 /* config/ia16/ia16-modes.def:48 */
#define HAVE_CCCmode
  CCCZmode,                /* config/ia16/ia16-modes.def:51 */
#define HAVE_CCCZmode
  CCCZ_NCmode,             /* config/ia16/ia16-modes.def:55 */
#define HAVE_CCCZ_NCmode
  CCCZ_Cmode,              /* config/ia16/ia16-modes.def:60 */
#define HAVE_CCCZ_Cmode
  CCSOmode,                /* config/ia16/ia16-modes.def:63 */
#define HAVE_CCSOmode
  CCSOZmode,               /* config/ia16/ia16-modes.def:66 */
#define HAVE_CCSOZmode
  CCSmode,                 /* config/ia16/ia16-modes.def:73 */
#define HAVE_CCSmode
  CCS_NCmode,              /* config/ia16/ia16-modes.def:77 */
#define HAVE_CCS_NCmode
  CCSCmode,                /* config/ia16/ia16-modes.def:81 */
#define HAVE_CCSCmode
  CCSZmode,                /* config/ia16/ia16-modes.def:86 */
#define HAVE_CCSZmode
  CCSCZmode,               /* config/ia16/ia16-modes.def:90 */
#define HAVE_CCSCZmode
...
#define HAVE_TImode
  PHImode,                 /* config/ia16/ia16-modes.def:30 */
#define HAVE_PHImode
...
#define HAVE_DCmode
  V2QImode,                /* config/ia16/ia16-modes.def:24 */
#define HAVE_V2QImode
  ...
  MIN_MODE_CC = CCmode,
  MAX_MODE_CC = CCSCZmode,

  MIN_MODE_INT = QImode,
  MAX_MODE_INT = TImode,

  MIN_MODE_PARTIAL_INT = PHImode,
  MAX_MODE_PARTIAL_INT = PHImode,
...
mode_size_inline (machine_mode mode)
{
  ...
  switch (mode)
    ...
    case CCZ_Cmode: return 4;
    case CCZ_NCmode: return 4;
    case CCCmode: return 4;
    case CCCZmode: return 4;
    case CCCZ_NCmode: return 4;
    case CCCZ_Cmode: return 4;
    case CCSOmode: return 4;
    case CCSOZmode: return 4;
    case CCSmode: return 4;
    case CCS_NCmode: return 4;
    case CCSCmode: return 4;
    case CCSZmode: return 4;
    case CCSCZmode: return 4;
...
mode_nunits_inline (machine_mode mode)
{
  ...
  switch (mode)
    ...
    case CCZ_Cmode: return 1;
    case CCZ_NCmode: return 1;
    case CCCmode: return 1;
    case CCCZmode: return 1;
    case CCCZ_NCmode: return 1;
    case CCCZ_Cmode: return 1;
    case CCSOmode: return 1;
    case CCSOZmode: return 1;
    case CCSmode: return 1;
    case CCS_NCmode: return 1;
    case CCSCmode: return 1;
    case CCSZmode: return 1;
    case CCSCZmode: return 1;
    case BImode: return 1;
    case QImode: return 1;
...
mode_inner_inline (machine_mode mode)
{
  ...
  switch (mode)
    ...
    case CCZ_Cmode: return CCZ_Cmode;
    case CCZ_NCmode: return CCZ_NCmode;
    case CCCmode: return CCCmode;
    case CCCZmode: return CCCZmode;
    case CCCZ_NCmode: return CCCZ_NCmode;
    case CCCZ_Cmode: return CCCZ_Cmode;
    case CCSOmode: return CCSOmode;
    case CCSOZmode: return CCSOZmode;
    case CCSmode: return CCSmode;
    case CCS_NCmode: return CCS_NCmode;
    case CCSCmode: return CCSCmode;
    case CCSZmode: return CCSZmode;
    case CCSCZmode: return CCSCZmode;
...
mode_unit_precision_inline (machine_mode mode)
{
  ...
  switch (mode)
    ...
    case CCZ_Cmode: return 4*BITS_PER_UNIT;
    case CCZ_NCmode: return 4*BITS_PER_UNIT;
    case CCCmode: return 4*BITS_PER_UNIT;
    case CCCZmode: return 4*BITS_PER_UNIT;
    case CCCZ_NCmode: return 4*BITS_PER_UNIT;
    case CCCZ_Cmode: return 4*BITS_PER_UNIT;
    case CCSOmode: return 4*BITS_PER_UNIT;
    case CCSOZmode: return 4*BITS_PER_UNIT;
    case CCSmode: return 4*BITS_PER_UNIT;
    case CCS_NCmode: return 4*BITS_PER_UNIT;
    case CCSCmode: return 4*BITS_PER_UNIT;
    case CCSZmode: return 4*BITS_PER_UNIT;
    case CCSCZmode: return 4*BITS_PER_UNIT;
    case BImode: return 1;
